...
public final class ActivityNewsBinding implements ViewBinding {
  ...
  private ActivityNewsBinding(@NonNull ConstraintLayout rootView, @NonNull TabLayout tabLayout,
  ...
  public static ActivityNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsBinding((ConstraintLayout) rootView, tabLayout, viewPager);
    }
